...
describe('CIP-0186 signed-connect known-answer vector (self-verified vs the SDK)', () => {
  ...
  it('emits the KAT + the spec canonical_subject vector', () => {
    ...
    const kat = {
      ...
      note: 'All inputs fixed and non-secret. A conforming wallet given these keys/nonces MUST reproduce signature + responseUrl byte-for-byte. A conforming dApp MUST accept the valid case and reject the negatives.',
      inputs: {
        redirect: REDIRECT,
